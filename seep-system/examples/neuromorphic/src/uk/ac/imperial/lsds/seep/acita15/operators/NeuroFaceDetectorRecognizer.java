...
public class NeuroFaceDetectorRecognizer implements StatelessOperator{

	private static final long serialVersionUID = 1L;
	private static final Logger logger = LoggerFactory.getLogger(NeuroFaceDetectorRecognizer.class);
